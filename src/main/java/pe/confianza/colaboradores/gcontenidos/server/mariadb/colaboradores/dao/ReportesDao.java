...
public interface ReportesDao extends JpaRepository<ReporteColaboradores, Long> {
	...
	@Query(value = "select * from reporte_seguimiento rs where rs.codigo_nivel1 like %:codigo or rs.codigo_nivel2 like %:codigo and rs.anio = :anio", nativeQuery = true)
	...
	@Query(value = "select * from reporte_seguimiento rs where (rs.codigo_nivel1 like %:codigo or rs.codigo_nivel2 like %:codigo) and rs.territorio in (:filtro) and rs.anio = :anio ", nativeQuery = true)
	...
	@Query(value = "select * from reporte_seguimiento rs where (rs.codigo_nivel1 like %:codigo or rs.codigo_nivel2 like %:codigo) and rs.colectivo in (:filtro) and rs.anio = :anio ", nativeQuery = true)
